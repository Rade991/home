...
/* 17. Za tri uneta broja ispisati koji od njih je najveći, koji od njih je srednji, a koji od nih je najmanji. */
...
elseif ($b<$c and $b>$a or $b>$c and $b<$a) {
    $mid = $b;
}
...
if ($godina%4==0 and ($godina%400==0 or $godina%100 != 0)) {
...
if ($dan <= 5 and $vreme < 20 and $vreme > 9) {
    echo "Radno je vreme posto je trenutno izmedju 9h i 20h radni dan.";
}

elseif ($dan >= 6 and $vreme < 18 and $vreme > 10) {
    echo "Radno je vreme posto je trenutno izmedju 10 i 18h vikendom.";
}
